...
# Related Work
Prior analyses of New York City traffic safety—including NYC DOT’s Vision Zero Borough Reports and research articles such as Ding et al. (2020) on urban crash risk—highlight consistent patterns in urban collisions, including peak-hour concentration, spatial clustering near commercial districts, and the strong role of driver inattention. News outlets such as The New York Times have also reported on rising pedestrian injuries in Manhattan and the persistent challenge of distracted driving. These works helped frame our investigation by emphasizing the importance of temporal-spatial patterns and human behavioral factors in explaining collision dynamics. Our project extends these ideas using more recent data, adds mapping and modeling components, and integrates traffic volume to test commonly cited but rarely quantified assumptions about collision risk.
...
Ensured consistency across duplicated entries by retaining the earliest timestamp per report.
These transformations produced a clean analytical dataset with N observations.
